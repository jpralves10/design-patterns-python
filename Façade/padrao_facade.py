'''
Façade -> Oculta as complexidades da estrutura interna de um objeto oferecendo uma interface ao cliente
para que ele possa acessar o sistema de forma simplificada.
'''
...
class Cliente:
    ...
    # Métodos do Python que faz o delet da memória
    def __del__(self):
